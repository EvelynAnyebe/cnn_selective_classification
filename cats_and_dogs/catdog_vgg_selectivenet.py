...
#         return self.model_embeding.predict(x, batch_size)
    ...
    def train(self, model, train_ds,val_ds=None):
        ...
        early_stop_callback=tf.keras.callbacks.EarlyStopping(
            monitor='loss', min_delta=0.0001, patience=10, mode="max", restore_best_weights=True
        )
        ...
        historytemp = model.fit(train_ds, validation_data=val_ds, epochs=maxepoches, shuffle=False, callbacks=[reduce_lr])
